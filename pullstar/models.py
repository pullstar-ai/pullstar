"""
pullstar.models — Python data model definitions for PullStar 1-on-1

These TypedDicts mirror the TypeScript interfaces in ui/src/types/pullstar.ts.
Engine code and scripts import from here to get typed dicts they can serialize
to JSON directly. Import-safe: type declarations only, no runtime behavior.
"""
